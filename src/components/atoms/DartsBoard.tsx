...
import './DartsBoard.scss';

interface Props {
  onBoardClick: (event: React.MouseEvent<SVGElement>) => void;
  isFinished: boolean;
}

export const Dartsboard: FC<Props> = ({ onBoardClick, isFinished }) => {
  return (
    <div className="Dartsboard">
      <svg
        ...
        height="778px"
        viewBox="0 0 803 778"
        enableBackground="new 0 0 803 778"
      >
        <g id="areas">
          <g id="board" className="board">
            <circle
          ...
          <g id="inner_single" filter="url(#drop-shadow)" className="single">
            <path
              onClick={onBoardClick}
              data-value={20}
              data-type={'single'}
              data-area={'inner'}
              d="M401 201.327c7.521 0 15 0.4 22.3 1.319l-19.938 152.518c-0.796-0.056-1.596-0.095-2.406-0.095 c-1.435 0-2.846 0.1-4.235 0.274l-28.171-151.236C379.217 202.3 390 201.3 401 201.327z"
            />
            <path
              onClick={onBoardClick}
              data-value={1}
              data-type={'single'}
              data-area={'inner'}
              d="M479.846 218.655l-66.101 138.907c-2.034-0.828-4.165-1.463-6.372-1.884l19.939-152.517 c16.062 2.2 31.7 6.6 46.7 12.914C476.002 216.9 477.9 217.8 479.8 218.655z"
            />
            <path
              onClick={onBoardClick}
              data-value={18}
              data-type={'single'}
              data-area={'inner'}
              d="M483.458 220.372c16.491 8.1 31.6 18.5 45.1 31.017l-105.769 111.7 c-1.691-1.425-3.522-2.689-5.472-3.766L483.458 220.372z"
            />
            <path
              onClick={onBoardClick}
              data-value={4}
              data-type={'single'}
              data-area={'inner'}
              d="M533.705 256.295c12.355 12.4 22.8 26.2 31.2 41.238l-135.129 73.5 c-1.18-1.886-2.539-3.646-4.054-5.26l105.77-111.661C532.237 254.9 533 255.6 533.7 256.295z"
            />
            <path
              onClick={onBoardClick}
              data-value={13}
              data-type={'single'}
              data-area={'inner'}
              d="M573.926 315.95c5.027 11.9 8.8 24.2 11.2 36.711l-151.229 28.17c-0.541-2.177-1.291-4.271-2.229-6.26 l135.123-73.525C569.397 305.9 571.8 310.9 573.9 315.95z"
            />
            <path
              onClick={onBoardClick}
              data-value={6}
              data-type={'single'}
              data-area={'inner'}
              d="M434.658 384.765l151.235-28.172c1.847 10.6 2.8 21.4 2.8 32.4 c0 7.521-0.448 14.975-1.319 22.345l-152.518-19.938c0.056-0.796 0.095-1.596 0.095-2.406 C434.932 387.6 434.8 386.2 434.7 384.765z"
            />
            <path
              onClick={onBoardClick}
              data-value={10}
              data-type={'single'}
              data-area={'inner'}
              d="M586.84 415.312c-2.248 16.062-6.556 31.705-12.914 46.738c-0.825 1.951-1.693 3.879-2.581 5.8 l-138.906-66.101c0.828-2.034 1.463-4.166 1.884-6.373L586.84 415.312z"
            />
            <path
              onClick={onBoardClick}
              data-value={15}
              data-type={'single'}
              data-area={'inner'}
              d="M569.628 471.458c-8.065 16.491-18.461 31.616-31.017 45.138L426.952 410.8 c1.425-1.691 2.688-3.522 3.766-5.471L569.628 471.458z"
            />
            <path
              onClick={onBoardClick}
              data-value={2}
              data-type={'single'}
              data-area={'inner'}
              d="M533.705 521.705c-12.355 12.355-26.175 22.797-41.238 31.207l-73.528-135.129c1.886-1.18 3.646-2.539 5.26-4.054 l111.661 105.77C535.145 520.2 534.4 521 533.7 521.705z"
            />
            <path
              onClick={onBoardClick}
              data-value={17}
              data-type={'single'}
              data-area={'inner'}
              d="M474.051 561.926c-11.888 5.027-24.157 8.772-36.712 11.234l-28.171-151.229 c2.178-0.541 4.271-1.291 6.261-2.229l73.525 135.124C484.106 557.4 479.1 559.8 474.1 561.926z"
            />
            <path
              onClick={onBoardClick}
              data-value={3}
              data-type={'single'}
              data-area={'inner'}
              d="M401 576.674c-7.519 0-14.968-0.448-22.335-1.318l19.936-152.519c0.793 0.1 1.6 0.1 2.4 0.1 c1.432 0 2.84-0.1 4.226-0.272l28.165 151.237C422.772 575.7 412 576.7 401 576.674z"
            />
            <path
              onClick={onBoardClick}
              data-value={19}
              data-type={'single'}
              data-area={'inner'}
              d="M327.95 561.926c-1.952-0.825-3.879-1.693-5.795-2.581l66.1-138.906 c2.034 0.8 4.2 1.5 6.4 1.884L374.688 574.84C358.626 572.6 343 568.3 327.9 561.926z"
            />
            <path
              onClick={onBoardClick}
              data-value={7}
              data-type={'single'}
              data-area={'inner'}
              d="M318.542 557.628c-16.491-8.065-31.616-18.461-45.137-31.017l105.769-111.66c1.691 1.4 3.5 2.7 5.5 3.8 L318.542 557.628z"
            />
            <path
              onClick={onBoardClick}
              data-value={16}
              data-type={'single'}
              data-area={'inner'}
              d="M268.295 521.705c-12.355-12.355-22.796-26.175-31.207-41.238l135.129-73.528 c1.179 1.9 2.5 3.6 4.1 5.26l-105.77 111.661C269.763 523.1 269 522.4 268.3 521.705z"
            />
            <path
              onClick={onBoardClick}
              data-value={8}
              data-type={'single'}
              data-area={'inner'}
              d="M228.074 462.051c-5.027-11.887-8.772-24.156-11.234-36.711l151.229-28.172c0.54 2.2 1.3 4.3 2.2 6.3 l-135.124 73.525C232.603 472.1 230.2 467.1 228.1 462.051z"
            />
            <path
              onClick={onBoardClick}
              data-value={11}
              data-type={'single'}
              data-area={'inner'}
              d="M367.069 389 c0-0.81 0.039-1.61 0.095-2.406l-152.518-19.938c-0.871 7.37-1.319 14.823-1.319 22.345c0 11 0.9 21.8 2.8 32.4 l151.236-28.173C367.169 391.8 367.1 390.4 367.1 389z"
            />
            <path
              onClick={onBoardClick}
              data-value={14}
              data-type={'single'}
              data-area={'inner'}
              d="M215.161 362.688c2.248-16.062 6.555-31.707 12.914-46.739c0.825-1.952 1.693-3.879 2.581-5.796l138.907 66.1 c-0.828 2.034-1.463 4.165-1.884 6.372L215.161 362.688z"
            />
            <path
              onClick={onBoardClick}
              data-value={9}
              data-type={'single'}
              data-area={'inner'}
              d="M232.372 306.542c8.066-16.491 18.461-31.617 31.017-45.137l111.66 105.8 c-1.425 1.691-2.689 3.522-3.766 5.471L232.372 306.542z"
            />
            <path
              onClick={onBoardClick}
              data-value={12}
              data-type={'single'}
              data-area={'inner'}
              d="M268.295 256.295c12.355-12.356 26.175-22.796 41.238-31.207l73.528 135.1 c-1.885 1.18-3.646 2.539-5.259 4.054l-111.662-105.77C266.855 257.8 267.6 257 268.3 256.295z"
            />
            <path
              onClick={onBoardClick}
              data-value={5}
              data-type={'single'}
              data-area={'inner'}
              d="M327.95 216.074c11.887-5.028 24.156-8.772 36.711-11.234l28.17 151.2 c-2.177 0.54-4.271 1.29-6.26 2.229l-73.525-135.124C317.894 220.6 322.9 218.2 327.9 216.074z"
            />
          </g>
          <g id="outer_single" filter="url(#drop-shadow)" className="single">
            <path
              onClick={onBoardClick}
              data-value={20}
              data-type={'single'}
              data-area={'outer'}
              d="M346.042 83.046l18.884 101.4 c11.825-2.069 23.87-3.111 36.074-3.111c8.396 0 16.7 0.5 24.9 1.484l13.367-102.25c-12.629-1.547-25.408-2.331-38.308-2.331 C382.4 78.2 364.1 79.8 346 83.046z"
            />
            <path
              onClick={onBoardClick}
              data-value={1}
              data-type={'single'}
              data-area={'outer'}
              d="M443.272 81.073l-13.365 102.2 c17.849 2.5 35.2 7.3 51.9 14.321c2.225 0.9 4.4 1.9 6.6 2.945l44.31-93.115c-3.562-1.667-7.15-3.29-10.786-4.828 C496.672 91.9 470.3 84.7 443.3 81.073z"
            />
            <path
              onClick={onBoardClick}
              data-value={18}
              data-type={'single'}
              data-area={'outer'}
              d="M492.061 202.294c18.388 9 35.2 20.6 50.3 34.564l70.898-74.847 c-22.955-21.496-48.725-39.215-76.883-52.84L492.061 202.294z"
            />
            <path
              onClick={onBoardClick}
              data-value={4}
              data-type={'single'}
              data-area={'outer'}
              d="M620.759 169.2 c-1.515-1.515-3.051-3.004-4.592-4.484l-70.903 74.852c0.869 0.8 1.7 1.7 2.6 2.5 c13.724 13.7 25.3 29.1 34.6 45.823l90.58-49.287C659.04 213.3 641.5 190 620.8 169.241z"
            />
            <path
              onClick={onBoardClick}
              data-value={13}
              data-type={'single'}
              data-area={'outer'}
              d="M674.995 242.188l-90.584 49.3 c2.885 5.4 5.5 11 8 16.681c5.592 13.2 9.7 26.9 12.5 40.837l101.372-18.883 c-4.072-21.24-10.351-41.992-18.849-62.083C683.627 259.2 679.5 250.6 675 242.188z"
            />
            <path
              onClick={onBoardClick}
              data-value={6}
              data-type={'single'}
              data-area={'outer'}
              d="M605.578 352.926c2.068 11.8 3.1 23.9 3.1 36.1 c0 8.396-0.503 16.715-1.484 24.94l102.251 13.367c1.546-12.629 2.33-25.408 2.33-38.308c0-18.6-1.623-36.95-4.832-54.958 L605.578 352.926z"
            />
            <path
              onClick={onBoardClick}
              data-value={10}
              data-type={'single'}
              data-area={'outer'}
              d="M708.928 431.272l-102.239-13.365 c-2.479 17.849-7.257 35.231-14.321 51.935c-0.941 2.226-1.932 4.423-2.945 6.606l93.114 44.3 c1.667-3.562 3.289-7.15 4.827-10.786C698.064 484.7 705.3 458.3 708.9 431.272z"
            />
            <path
              onClick={onBoardClick}
              data-value={15}
              data-type={'single'}
              data-area={'outer'}
              d="M587.706 480.062c-8.97 18.388-20.556 35.244-34.564 50.299l74.847 70.9 c21.496-22.955 39.216-48.725 52.841-76.883L587.706 480.062z"
            />
            <path
              onClick={onBoardClick}
              data-value={2}
              data-type={'single'}
              data-area={'outer'}
              d="M625.243 604.167l-74.852-70.902 c-0.84 0.868-1.678 1.738-2.533 2.594c-13.725 13.724-29.081 25.313-45.823 34.639l49.287 90.6 c25.391-14.035 48.662-31.543 69.437-52.317C622.273 607.2 623.8 605.7 625.2 604.167z"
            />
            <path
              onClick={onBoardClick}
              data-value={17}
              data-type={'single'}
              data-area={'outer'}
              d="M547.812 663 l-49.29-90.584c-5.424 2.885-10.981 5.546-16.681 7.956c-13.222 5.592-26.87 9.748-40.837 12.473l18.883 101.4 c21.241-4.072 41.993-10.351 62.084-18.849C530.807 671.6 539.4 667.5 547.8 662.995z"
            />
            <path
              onClick={onBoardClick}
              data-value={3}
              data-type={'single'}
              data-area={'outer'}
              d="M455.937 694.958l-18.88-101.377 c-11.819 2.066-23.858 3.108-36.057 3.108c-8.393 0-16.708-0.503-24.93-1.482l-13.365 102.2 c12.625 1.5 25.4 2.3 38.3 2.329C419.593 699.8 437.9 698.2 455.9 694.958z"
            />
            <path
              onClick={onBoardClick}
              data-value={19}
              data-type={'single'}
              data-area={'outer'}
              d="M358.728 696.9 l13.366-102.239c-17.849-2.479-35.233-7.257-51.936-14.321c-2.225-0.941-4.422-1.932-6.605-2.945l-44.31 93.1 c3.562 1.7 7.2 3.3 10.8 4.827C305.328 686.1 331.7 693.3 358.7 696.928z"
            />
            <path
              onClick={onBoardClick}
              data-value={7}
              data-type={'single'}
              data-area={'outer'}
              d="M309.939 575.706c-18.388-8.97-35.245-20.556-50.299-34.564l-70.898 74.8 c22.955 21.5 48.7 39.2 76.9 52.84L309.939 575.706z"
            />
            <path
              onClick={onBoardClick}
              data-value={16}
              data-type={'single'}
              data-area={'outer'}
              d="M185.833 613.2 l70.903-74.852c-0.868-0.84-1.738-1.678-2.594-2.533c-13.724-13.725-25.313-29.081-34.638-45.823l-90.58 49.3 c14.036 25.4 31.5 48.7 52.3 69.437C182.756 610.3 184.3 611.8 185.8 613.243z"
            />
            <path
              onClick={onBoardClick}
              data-value={8}
              data-type={'single'}
              data-area={'outer'}
              d="M127.005 535.812l90.584-49.29 c-2.885-5.424-5.546-10.981-7.956-16.681c-5.592-13.221-9.749-26.869-12.473-40.836L95.789 447.9 c4.072 21.2 10.3 42 18.8 62.082C118.373 518.8 122.5 527.4 127 535.812z"
            />
            <path
              onClick={onBoardClick}
              data-value={11}
              data-type={'single'}
              data-area={'outer'}
              d="M95.046 443.96c-3.209-18.009-4.833-36.359-4.833-54.96c0-12.899 0.784-25.678 2.331-38.307 l102.25 13.367c-0.981 8.225-1.484 16.544-1.484 24.94c0 12.2 1 24.2 3.1 36.075L95.046 443.96z"
            />
            <path
              onClick={onBoardClick}
              data-value={14}
              data-type={'single'}
              data-area={'outer'}
              d="M93.073 346.728l102.239 13.366c2.479-17.849 7.256-35.233 14.321-51.936 c0.941-2.225 1.932-4.422 2.945-6.605l-93.115-44.31c-1.667 3.562-3.29 7.15-4.828 10.8 C103.936 293.3 96.7 319.7 93.1 346.728z"
            />
            <path
              onClick={onBoardClick}
              data-value={9}
              data-type={'single'}
              data-area={'outer'}
              d="M214.294 297.938c8.97-18.388 20.556-35.244 34.564-50.298 l-74.848-70.898c-21.495 22.955-39.214 48.724-52.84 76.883L214.294 297.938z"
            />
            <path
              onClick={onBoardClick}
              data-value={12}
              data-type={'single'}
              data-area={'outer'}
              d="M176.756 173.8 l74.853 70.903c0.839-0.868 1.677-1.738 2.533-2.594c13.724-13.724 29.08-25.313 45.823-34.639l-49.287-90.58 c-25.392 14.036-48.663 31.543-69.437 52.317C179.726 170.8 178.2 172.3 176.8 173.833z"
            />
            <path
              onClick={onBoardClick}
              data-value={5}
              data-type={'single'}
              data-area={'outer'}
              d="M254.187 115 l49.29 90.584c5.423-2.885 10.982-5.546 16.681-7.956c13.221-5.592 26.87-9.749 40.837-12.473L342.112 83.8 c-21.24 4.071-41.993 10.35-62.083 18.848C271.193 106.4 262.6 110.5 254.2 115.005z"
            />
          </g>
          <g id="double_area" className="double">
            <path
              onClick={onBoardClick}
              data-value={20}
              data-type={'double'}
          ...
          <g id="triple_area" className="triple">
            <path
              onClick={onBoardClick}
              data-value={20}
              data-type={'triple'}
